! function(e) {
    ...
    function r(t, o) {
        var c = this;
        return this.element = t, this.options = e.extend({}, n, o), this._defaults = n, this._name = i, this._list = {}, this._filter = {}, this._ccData = {}, this._ccPicker = {}, this._ccDialCodeTrackerField = {}, this._ccSelectedCountry = {}, this.init(), {
            setCountryByPhoneCode: function(t) {
                var o = c.findCountryByPhoneCode(c, t);
                c._ccPicker.html(c.createCountryListItem(o.code, o.phoneCode)), c._ccDialCodeTrackerField.val(o.phoneCode), c._ccSelectedCountry = {
                    code: o.code,
            ...
            enable: function() {
                e(c.element).prop("disabled", !1), c._ccPicker.off("click"), c._ccPicker.on("click", function(t) {
    ...
    e.extend(r.prototype, {
        init: function() {
            ...
            this._ccPicker = e('<div class="cc-picker cc-picker-code-select-enabled">').insertBefore(this.element), this._ccDialCodeTrackerField = e("<input>").attr({
                ...
                value: o.phoneCode
            }).insertAfter(this.element), this._ccPicker.prepend(this.createCountryListItem(this.options.countryCode.toLowerCase(), o.phoneCode)), this._ccSelectedCountry = {
        ...
        createCountryList: function(t) {
            ...
            t._list = e("<ul/>", {
                ...
                e(i).data("countryItem", c), e(i).prepend(t.createCountryListItem(c.code, c.phoneCode)), e(i).on("click", function() {
