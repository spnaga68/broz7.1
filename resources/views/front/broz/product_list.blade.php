   ...
   <div class="container">
      ...
      <div class="store_img">
         ...
         <div class="store_details_sec">
            ...
            <h4>@lang('messages.Delivery within') {{ $outlet_info->outlets_delivery_time }} @lang('messages.minutes')</h4>
         </div>
         <div class="store_icons">
            <ul>
             <li class="home info_active" ><a style="cursor:pointer;" title="@lang('messages.Home')"  onclick="back_product()" ><i class="icons"><img src="{{ URL::asset('assets/front/'.Session::get('general')->theme.'/images/home_icon.png') }}" alt=""></i></a></li>
               <li <?php if($fstatus){ ?> class="info_active" <?php } ?> ><a style="cursor:pointer;" class="favourite" <?php if(!Session::get('user_id')){ ?> data-toggle="modal" data-target="#myModal2"  <?php } else {  ?>  title="@lang('messages.Favourites')" onclick="favourite(<?php echo $outlet_info->outlets_id;?>)" <?php } ?> ><i class="glyph-icon flaticon-favorite-1"></i></a></li>
      ...
      <div class="bottom_search">
         ...
         <div class="product_search_box">
            <div class="inner-addon right-addon">
               ...
               <input class="form-control" value="{{ Input::get('keyword') }}" id="textbx" name="keyword" type="text" placeholder="@lang('messages.Search')">
            </div>
         </div>
         {!!Form::close();!!}
      </div>
            ...
            <div class="col-md-3 col-xs-6 col-sm-6">
               <div class="item_common_new" data-toggle="modal" data-target=".exampleModal<?php echo $pro->product_id;?>" data-whatever="@mdo">
                  <div class="store_list_img">
                     ...
                     <?php } else{  ?>
                     <a href="javascript:;" title=""><img src="{{ URL::asset('assets/admin/base/images/products/product.png') }}" alt="{{ ucfirst(strtolower($pro->product_name)) }}"></a>
                     <?php } ?>	
                  </div>
                  <div class="store_list_desc">
                     <a href="javascript:;" style="cursor:pointer;" title="{{ strtolower($pro->product_name) }}">{{ ucfirst(strtolower(trim($pro->product_name))) }}  ({{ $pro->weight }}{{ $pro->unit }})</a>
                                 ...
                                 <div class="cart_infor">
                                    ...
                                    <form method="POST" name="appointment_form" accept-charset="UTF-8" id="add_cart_form<?php echo $pro->product_id;?>">
                                       ...
                                       <div class="col-md-4 col-sm-4 col-xs-4 padding_right0">
                                          ...
                                          <p class="cat_price1" style="display:none;color: #e91e63;font-size: 24px;font-weight: 500;text-align: right;">  {{  $pro->product_cart_count*$pro->discount_price }} <?php echo $currency_symbol; ?></p>
                                          <?php } ?>
                                       </div>
               ...
               <div class="no_data col-md-12">
                  <div class="no_store_avlable store_info_new">
                     <div class="no_store_img">
                        ...
                        <p>@lang('messages.There are no products available based on your search')</p>
                     </div>
                  </div>
               </div>
            </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="delevery_free">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <?php if($currency_side == 1) { ?>
                                        <h4>{{  $currency_symbol }} {{ $outlet_info->outlets_delivery_charges_fixed }} </h4>
                                    <?php } else { ?>
                                        <h4>{{ $outlet_info->outlets_delivery_charges_fixed }} {{$currency_symbol }}</h4>
                                    <?php } ?>
                                </div>
                            </div>
                            <div class="delevery_free">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <h4>{{ $outlet_info->outlets_pickup_time }} @lang('messages.Mins')</h4>
                                </div>
                            </div>
                            <div class="delevery_free">
                                <div class="col-md-4"><i class="glyph-icon flaticon-wait"></i></div>
                                <div class="col-md-8">
                                    ...
                                    <h4>{{ $outlet_info->outlets_delivery_time }} @lang('messages.Mins')</h4>
                                </div>
                            </div>
                        </div>
            <div class="col-md-8">
               <div class="map_sections">
                  ...
                  <script type="text/javascript">
                     function initialize() {
                     	...
                     	var latlng = new google.maps.LatLng('<?php echo $outlet_info->outlets_latitude; ?>','<?php echo $outlet_info->outlets_longitude; ?>');
                     	var myOptions = {
                     	zoom: 8,
                     	center: latlng,
                  ...
                  <div class="social_share_info">
                     ...
                     <ul>
                       ...
                       <?php /* <li><a target="_blank" href="http://www.linkedin.com/shareArticle?mini=true&url=<?php echo $url1; ?>" title="instagram" class="in_icon"><i class="glyph-icon flaticon-instagram-social-network-logo-of-photo-camera"></i></a></li> */?>
