                ...
                <div class="col-md-6">
                    <div class="port_opt_left">
                        ...
                        <div class="port_opt_top">
							...
							<?php } else{  ?>
							<img  src=" {{ URL::asset('assets/front/'.Session::get('general')->theme.'/images/blog_no_images.png') }} " alt="{{ ucfirst($value->title) }}">
                ...
                <div class="col-md-6">
                    <div class="port_opt_right port_opt_top">
                        ...
                        @if ($value->iphone_link)
                            <a href="{{ $value->iphone_link }}" target="_blank" title="Apple store"><img src="<?php echo URL::asset('assets/front/'.Session::get("general")->theme.'/images/app_store.png');?>" alt="Apple store">
                            </a>
                        @endif    
                        @if ($value->android_link)   
                            <a href="{{ $value->android_link }}" target="_blank" title="Google play store"><img src="<?php echo URL::asset('assets/front/'.Session::get("general")->theme.'/images/google_play.png');?>" alt="Google play store">
                            </a>
                        @endif 
                        @if ($value->web_link)    
                            <a href="{{ $value->web_link }}" target="_blank" title="Google play store"><img src="<?php echo URL::asset('assets/front/'.Session::get("general")->theme.'/images/web_links.png');?>" alt="Google play store">
                            </a>
                        @endif 
