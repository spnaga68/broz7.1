...
<div class="cart_sections_tables">
	...
	<h3>@lang('messages.Order details')</h3>
	<div class="deli_list">
...
<div class="deli_list">
	<div class="col-md-3 col-sm-6 col-xs-6 padding_left0">
	<h4>@lang('messages.Promo code discount')</h4>
	</div>
	<div class="col-md-9 col-sm-6 col-xs-6 padding_right0">
		<?php if($currency_side == 1) { ?>
	<h4>{{$currency_symbol.$delivery_details[0]->coupon_amount}}</h4>
	<?php } else { ?>
		<h4>{{$currency_symbol.$delivery_details[0]->coupon_amount}}</h4>
		<?php } ?>
	</div>
...
<?php } ?>
	<?php if($delivery_details[0]->order_type == 1){ ?>
		...
		<div class="deli_list">
			<div class="col-md-3 col-sm-6 col-xs-6 padding_left0">
				<h4>@lang('messages.Delivery time')</h4>
			</div>
			<div class="col-md-9 col-sm-6 col-xs-6 padding_right0">
	...
	<div class="deli_list">
	<div class="col-md-3 col-sm-6 col-xs-6 padding_left0">
	<h4>@lang('messages.Additional notes')</h4>
	</div>
	<div class="col-md-9 col-sm-6 col-xs-6 padding_right0"> 
