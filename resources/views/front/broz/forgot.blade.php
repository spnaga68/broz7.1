        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <span class="logo_popup"><img alt="{{Session::get('general')->site_name}}" src="<?php echo url('/assets/front/'.Session::get("general")->theme.'/images/'.Session::get("general")->theme.'.png?'.time()); ?>"></span>
                </div>
