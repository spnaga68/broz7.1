	...
	<p>@lang('messages.Not yet registered?')</p>
	<div class="but_reg">
...
<h1>@lang('messages.Selling through :site_name is as easy as 1.2.3...', ['site_name' => Session::get("general")->site_name])</h1>
...
<h3>19</h3>
<p>@lang('messages.Cities across Saudi Arabia')</p>
</div>
</div>
<div class="col-md-4 border-right">
<div class="cites_list">
