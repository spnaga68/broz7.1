...
<div class="media">
	...
	<div class="media-body">
		<ul class="breadcrumb">
			<li><a href="{{ URL::to('vendors/dashboard') }}"><i class="glyphicon glyphicon-home"></i>@lang('messages.Outlet Managers')</a></li>
							...
							<select name="order_status_id" id="input-order-status" class="form-control">
								...
								//11 Delivered
								 if($delivery_details[0]->order_type==2) {
									 ...
									 ?>
									 <option value="{{$order_status_list['id']}}">{{$order_status_list['name']}}</option> 
							<?php } else {
