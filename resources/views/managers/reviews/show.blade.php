        ...
        <div class="pageheader">
            <div class="media">
                ...
                <div class="media-body">
                    ...
                    <h4>@lang('messages.View review')</h4>
                </div>
            </div><!-- media -->
        </div><!-- pageheader -->
            ...
            <div class="tab-content mb30">
                <div class="tab-pane active" id="home3">
                    <?php /*<div class="form-group">
                        ...
                        <div class="col-sm-3">{{ $review->title }}</div>
                    </div>*/ ?>
                    <div class="buttons_block pull-right">
                        <div class="btn-group mr5">
                            <a class="btn btn-primary tip" href="{{ url('managers/reviews') }}" title="@lang('messages.Back')">@lang('messages.Back')</a>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="index" class="col-sm-3 control-label"> @lang('messages.Comments') :</label>
                        <div class="col-sm-6"><?php echo $review->comments; ?></div>
                    </div>
                    <div class="form-group">
                        <label for="index" class="col-sm-3 control-label"> @lang('messages.Rating') :</label>
                        <div class="col-sm-6"><div class="rateit" data-rateit-value="<?php echo $review->ratings; ?>" data-rateit-ispreset="true" data-rateit-readonly="true"></div></div>
                    </div>
                    <div class="form-group">
                        <label for="index" class="col-sm-3 control-label"> @lang('messages.Posted by') :</label>
                        <div class="col-sm-6"><?php echo $review->user_name; ?></div>
                    </div>
                    <div class="form-group">
                        <label for="index" class="col-sm-3 control-label"> @lang('messages.Posted to') :</label>
                        <div class="col-sm-6"><?php echo $review->outlet_name; ?></div>
                    </div>
                    <div class="form-group">
                        <label for="index" class="col-sm-3 control-label"> @lang('messages.Posted date') :</label>
                        <div class="col-sm-6"><?php echo date('d - M - Y h:i A' , strtotime($review->review_posted_date)); ?></div>
                    </div>
                    <div class="form-group">
