						...
						<div class="panel panel-default">
							<div class="panel-heading">
								<div class="logo text-center logo_setions_absolut">
									<img title="<?php echo $site_name; ?>" alt="<?php echo $site_name; ?>" src="<?php echo url('/assets/front/'.Session::get("general")->theme.'/images/logo/159_81/admin_logo.png'); ?>" >
								</div>
							</div>
							<div class="panel-body">
								...
								@endif
								<form class="form-horizontal" role="form" method="POST" action="{{ url('/managers/forgot_mail') }}">
								{!! csrf_field() !!}
