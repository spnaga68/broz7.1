	...
	<div class="media">
		...
		<div class="media-body">
			<ul class="breadcrumb">
				...
				<li>@lang('messages.View Order Return')</li>
			</ul>
	...
	<div class="col-md-12">
		<div class="buttons_block pull-right">
			<div class="btn-group mr5">
				<a class="btn btn-primary tip" href="{{ URL::to('managers/return_orders') }}" title="Edit" >@lang('messages.Back')</a>
			</div>
		</div>
		<div class="row panel panel-default">
			<div class="grid simple">
				...
				<ul class="nav nav-justified nav-wizard nav-pills">
					...
					<li @if(old('tab_info')=='vendor_info') class="active" @endif ><a href="#vendor_info" class="vendor_info" data-toggle="tab"><strong>@lang('messages.Merchant Information')</strong></a></li>
				...
				<div class="tab-content tab-content-simple mb30 no-padding" >
					<div class="tab-pane active" id="login_info">
						...
						<div class="form-group">
							<label class="col-sm-5 control-label">@lang('messages.Customer Comments')</label>
							<div class="col-sm-7">{!! (!empty($data[0]->return_comments))?$data[0]->return_comments:'' !!}</div>
						</div>
						<div class="form-group">
							<label class="col-sm-5 control-label">@lang('messages.Current Return Reason')</label>
							<div class="col-sm-7">{!! $data[0]->return_reason_name !!}</div>
						</div>
						<div class="form-group">
							<label class="col-sm-5 control-label">@lang('messages.Current Return Status')</label>
							<div class="col-sm-7">{!! $data[0]->return_status_name !!}</div>
						</div>
						<div class="form-group">
							<label class="col-sm-5 control-label">@lang('messages.Current Return Action')</label>
							<div class="col-sm-7">{!! $data[0]->return_action_name !!}</div>
						</div>
						{!!Form::open(array('url' => ['managers/update_return_orders',$data[0]->id], 'method' => 'post','id'=>'product_form','files' => true));!!}
						<div class="form-group">
							...
							<label class="col-sm-5 control-label ">@lang('messages.Return Reason')</label>
							<div class="col-sm-7">
						...
						<div class="form-group">
							<label class="col-sm-5 control-label ">@lang('messages.Return Action')</label>
							<div class="col-sm-7">
						...
						<div class="form-group">
							<label class="col-sm-5 control-label ">@lang('messages.Return Status') <span class="asterisk">*</span></label>
							<div class="col-sm-7">
					...
					<div class="tab-pane" id="vendor_info">
						...
						<div class="form-group">
							<label class="col-sm-5 control-label">@lang('messages.Order Id')</label>
							<div class="col-sm-7">{!! $data[0]->order_key_formated !!}</div>
						</div>
						<div class="form-group">
							<label class="col-sm-5 control-label">@lang('messages.Order Key')</label>
							<div class="col-sm-7">{!! $data[0]->order_key !!}</div>
						</div>
						<div class="form-group">
							<label class="col-sm-5 control-label">@lang('messages.Invoice Id')</label>
							<div class="col-sm-7">{!! $data[0]->invoice_id !!}</div>
						</div>
						<div class="form-group">
							<label class="col-sm-5 control-label">@lang('messages.Order Status')</label>
							<div class="col-sm-7">{!! $data[0]->order_status !!}</div>
						</div>
						<div class="form-group">
							<label class="col-sm-5 control-label">@lang('messages.Order Date')</label>
							<div class="col-sm-7">{!! $data[0]->ordered_date !!}</div>
						</div>
						<div class="form-group">
							<label class="col-sm-5 control-label">@lang('messages.Payment Type')</label>
							<div class="col-sm-7">{!! $data[0]->name !!}</div>
						</div>
						<div id="order_details">
							...
							<table class="table table-bordered">
								<thead>
									<tr>
										<th class="text-left">@lang('messages.Product Info')</td>
										<th class="text-left">@lang('messages.Item Price')</td>
								...
								foreach($items_data as $items){
									...
									<tr>
										<td class="text-left"><img width="50px" height="50px" src="<?php echo url('/assets/admin/base/images/products/thumb/'.$items->product_image.''); ?>" alt="{{ucfirst($items->product_name)}}" /><?php echo str_limit(ucfirst(strtolower($items->product_name)),30); ?></td>
										<td class="text-left"><?php echo $items->item_cost." ".$data[0]->currency_code; ?></td>
										<td class="text-left"><?php echo $items->item_unit; ?></td>
					...
					<div class="tab-pane" id="delivery_info"> 
						...
						<div class="form-group">
							<label class="col-sm-5 control-label">@lang('messages.User Name')</label>
							<div class="col-sm-7">{!! $data[0]->username !!}</div>
						</div>
						<div class="form-group">
							<label class="col-sm-5 control-label">@lang('messages.Email')</label>
							<div class="col-sm-7">{!! $data[0]->email !!}</div>
						</div>
						<div class="form-group">
							<label class="col-sm-5 control-label">@lang('messages.First name')</label>
							<div class="col-sm-7">{!! ($data[0]->first_name)?$data[0]->first_name:'-' !!}</div>
						</div>
						<div class="form-group">
							<label class="col-sm-5 control-label">@lang('messages.Last name')</label>
							<div class="col-sm-7">{!! ($data[0]->last_name)?$data[0]->last_name:'-' !!}</div>
						</div>
						<div class="form-group">
							<label class="col-sm-5 control-label">@lang('messages.Mobile')</label>
							<div class="col-sm-7">{!! $data[0]->mobile !!}</div>
						</div>
					</div>
					<div class="tab-pane" id="contact_info"> 
						<legend>@lang('messages.Store and Delivery Information')</legend>
						<div class="form-group">
							<label class="col-sm-5 control-label">@lang('messages.Delivery Address')</label>
							<div class="col-sm-7">{!! ($data[0]->address)?$data[0]->address:'-' !!}</div>
						</div>
						<div class="form-group">
							<label class="col-sm-5 control-label">@lang('messages.Delivery Instructions')</label>
							<div class="col-sm-7"><?php echo date("d F, l", strtotime($data[0]->delivery_date)); ?></div>
						</div>
						<div class="form-group">
							<label class="col-sm-5 control-label">@lang('messages.Delivery Slot')</label>
							<div class="col-sm-7">{!! $data[0]->start_time !!}-{!! $data[0]->end_time !!}</div>
						</div>
						<div class="form-group">
							<label class="col-sm-5 control-label">@lang('messages.Delivery Instructions')</label>
							<div class="col-sm-7">{!! $data[0]->delivery_instructions !!}</div>
						</div>
						<div class="form-group">
							<label class="col-sm-5 control-label">@lang('messages.Merchant name')</label>
							<div class="col-sm-7">{!! $data[0]->vendor_name !!}</div>
						</div>
						<div class="form-group">
							<label class="col-sm-5 control-label">@lang('messages.Restaurant Name')</label>
							<div class="col-sm-7">{!! $data[0]->outlet_name !!}</div>
						</div>
						<div class="form-group">
							<label class="col-sm-5 control-label">@lang('messages.Restaurant Address')</label>
							<div class="col-sm-7">{!! $data[0]->contact_address !!}</div>
						</div>
					</div>
				</div>
			</div>
