								...
								<div class="edit_profile_section">
									...
									<div class="edit_orofile_sections_inner">
										{!!Form::open(array('url' => 'update-profile', 'method' => 'post', 'class' => 'tab-form attribute_form', 'id' => 'sign_up'));!!} 
											...
											<div class="col-md-6">
                                                <div class="form-group">
                                                    <!-- <input type="tel" name="phone" maxlength="15" class="form-control" id="phone" value="{{$user_details->mobile}}" required placeholder="@lang('messages.Phone')"> -->
                                                    <input type="tel" maxlength="15" name ="phone" class="form-control" id="phone" value="{{$user_details->mobile}}" required placeholder="@lang('messages.Phone')">
                                                    <p id="mobile_error_text"> </p>
                                                   <!-- <span style="color:#c2c2c2;">@lang('messages.Ex:+91 is must')</span> -->
                                                </div>
                                            </div>
											<div class="col-md-6">
...
<script type="text/javascript">
  ...
  $("#phone").intlTelInput({
	...
	$(document).ready(function() {
		...
		if((mobile == ""))
		{
			$('#mobile_error_text').html('Please update your phone number.');
		}
		//Horizontal Tab
