	...
	<?php  
		...
		{?>
			<a href="{{ $blog->url_index }}"><?php $image_url = url('/assets/admin/base/images/blog/914_649/'.$blog->image.'');
		} else { ?>
			<a href="{{ $blog->url_index }}"><?php $image_url =  URL::asset('assets/admin/base/images/blog_det_bg.jpg');
		} ?>
		
	<input type="hidden" class="getiamge" value="<?php echo $image_url; ?>">
    <section class="banner_sections_inner blog_det" style="background-image: url({{$image_url}})">
...
<?php  if(file_exists(base_path().'/public/assets/admin/base/images/admin/profile/thumb/'.$users->image)) { ?>
	<a href="{{ $blog->url_index }}"><img src="<?php echo url('/assets/admin/base/images/admin/profile/thumb/'.$users->image.''); ?>" ></a>
	
		<?php } else{  ?>
		<a href="{{ $blog->url_index }}"><img src=" {{ URL::asset('assets/admin/base/images/a2x.jpg') }} " ><>
<?php } ?></a>
</div>
</div>
<div class="col-md-9">
...
<li><p>@lang('messages.Share at')</p></li>
                                        ...
                                        <li>
                                            <a target="_blank" href="http://www.linkedin.com/shareArticle?mini=true&url=<?php echo $url; ?>" title="Linked In" class="linked1">
