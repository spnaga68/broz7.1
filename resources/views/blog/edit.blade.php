...
<ul class="nav nav-tabs"></ul>
	...
	<div class="tab-pane active" id="home3">
		...
		<div class="form-group">
			<label class="col-sm-2 control-label">@lang('messages.Blog link')</label>
			<div class="col-sm-10">
			  <input type="text" name="blog_link" value="<?php echo $data->blog_link; ?>"  maxlength="255" placeholder="@lang('messages.Blog link')"  class="form-control" maxlength="30" />
			</div>
		</div>
