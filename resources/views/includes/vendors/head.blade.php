...
<?php /* echo app_path().'<br>'.base_path().'<br>'.config_path().'<br>'.database_path().'<br>'.public_path().'<br>'.storage_path(); */ ?>
    ...
    <script type="text/javascript" src="{{ URL::asset('assets/admin/base/js/bootstrap.min.js') }}"></script>
     ...
     <script>	var currentlanguage = '<?php echo $currentlanguage;?>'; </script>
...
<link rel="shortcut icon" href="<?php echo url('/assets/front/'.Session::get("general")->theme.'/images/favicon/16_16/'.Session::get("general")->favicon.''); ?>">
