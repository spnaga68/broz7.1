	...
	<ul class="nav nav-pills nav-stacked">
		...
		<li class="parent {{ (Request::is('vendors/return_orders*') || Request::is('vendors/orders*') || Request::is('vendors/request_amount/*')) ? 'active' : ''}}"><a  href="#"><i class="fa fa-database"></i> <span>@lang('messages.Sales')</span></a>
			<ul class="children">
				...
				<li class="{{ Request::is('vendors/request_amount*') ? 'active' : '' }}" ><a  href="{{ URL::to('vendors/request_amount/index') }}">@lang('messages.Request Amount')</a></li>
			</ul>
		</li>
		...
		<li class="{{ Request::is('vendors/drivers*') ? 'active' : '' }}" ><a href="{{ URL::to('vendors/drivers') }}"><i class="fa fa-bell"></i> <span>@lang('messages.drivers')</span></a></li>
		
		<li class="{{ Request::is('vendors/salesperson*') ? 'active' : '' }}" ><a href="{{ URL::to('vendors/salesperson') }}"><i class="fa fa-bell"></i> <span>@lang('messages.salesperson')</span></a></li>
