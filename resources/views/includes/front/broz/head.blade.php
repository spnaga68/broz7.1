<html lang="en" ng-app="app" ng-controller="titleCtrl">
   <head>
     ...
     <?php if(App::getLocale()=='ar') {  ?>
      ...
      <style type="text/css">
         <?php if(request()->path() == 'driverabout-us' || request()->path() == 'customerabout-us'|| request()->path() == 'customerterms-condition'|| request()->path() == 'driverterms-condition'){  ?>
          .main_head{
            display: none;
          <?php }
          ?> 
                          ...
                          <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                            <div class="col-md-7 col-sm-6 col-xs-6 responsive_hidde">
                              <ul class="nav navbar-nav navbar-right">
                                ...
                                <li><a href="{{ URL::to('/promotion') }}" title="@lang('messages.promotion')">@lang('messages.promotion')</a>
                                </li> 

                                <li><a href="{{ URL::to('/outlets') }}" title="@lang('messages.outlets')">@lang('messages.outlets')</a>
                                </li>
