...
<div class="media">
	...
	<div class="media-body">
		...
		<h4>@lang('messages.Edit Cms') - {{$infomodel->getLabel('title',getAdminCurrentLang(),$data->id)}}</h4>
	</div>
</div><!-- media -->
</div><!-- pageheader -->
...
<ul class="nav nav-tabs"></ul>
    ...
    {!!Form::open(array('url' => ['updatecms', $data->id], 'method' => 'post','class'=>'tab-form attribute_form','id'=>'cms_form','files' => true));!!} 
	...
	<div class="tab-pane active" id="home3">
		...
		<div class="form-group">
                ...
                <div class="col-sm-10">
                    ...
                    <div class="input-group translatable_field language-<?php echo $language->id;?>" <?php if($i > 0):?>style="display: none;"<?php endif;?>>
                          <input type="text" name="title[<?php echo $language->id;?>]" id="suffix_<?php echo $language->id;?>"  placeholder="<?php echo trans('messages.Title').trans('messages.'.'('.$language->name.')');?>" class="form-control" value="{{$infomodel->getLabel('title',$language->id,$data->id)}}"  />
		...
		<div class="form-group">
			...
			<div class="col-sm-10">
			  <input type="text" name="index" value="<?php echo $data->url_index; ?>" maxlength="255" placeholder="@lang('messages.Url index')"  class="form-control"  />
			</div>
		</div>
      ...
      <div class="form-group">
			...
			<div class="col-sm-10">
			  <input type="number"  name="sort_order" value="<?php echo $data->sort_order; ?>"  maxlength="10" placeholder="@lang('messages.Sort order')"  class="form-control"  />
			</div>
		</div>
			...
			<div class="form-group">
				...
				<div class="row ">
					<div class="col-sm-10" style="padding-right: 0;">
                       <textarea class="form-control" rows="8" cols="100"  name="meta_description[<?php echo $language->id;?>]" id="suffix_<?php echo $language->id;?>"  placeholder="<?php echo trans('messages.Meta Description').trans('messages.'.'('.$language->name.')');?>" class="form-control" >{{$infomodel->getLabel('meta_description',$language->id,$data->id)}}</textarea>
					</div>
	   ...
	   <div class="form-group">
		  <label  class="col-sm-2 control-label">@lang('messages.Status')</label>
			<div class="col-sm-10">
			<?php $checked = "";
			 if($data->cms_status){ $checked = "checked=checked"; }?>
		...
		<button type="reset" title="@lang('messages.Cancel')" class="btn btn-default" onclick="window.location='{{ url('admin/cms') }}'">@lang('messages.Cancel')</button>
		</div>
        </div>
