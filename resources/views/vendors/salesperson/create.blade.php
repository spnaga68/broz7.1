...
<div class="row">
    <div class="col-md-12 ">
        ...
        <div class="pageheader">
            <div class="media">
                ...
                <div class="media-body">
                    ...
                    <h4>@lang('messages.Add Salesperson')</h4>
                </div>
            </div><!-- media -->
        </div><!-- pageheader -->
        <div class="contentpanel">
            ...
            {!!Form::open(array('url' => 'create_vendorSalesperson', 'method' => 'post', 'class' => 'tab-form attribute_form', 'id' => 'create_driver_form', 'files' => true));!!} 
                    ...
                    <div class="tab-pane active" id="home3">
                       <?php /** <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input type="text" name="first_name" maxlength="30" placeholder="@lang('messages.Name')" class="form-control" value="{!! old('first_name') !!}" />
                            </div>
                        </div>
