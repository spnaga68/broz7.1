...
<div class="row">
    <div class="col-md-12 ">
        ...
        <div class="pageheader">
            <div class="media">
                ...
                <div class="media-body">
                    ...
                    <h4>@lang('messages.Edit SalesPerson')</h4>
                </div>
            </div><!-- media -->
        </div><!-- pageheader -->
        <div class="contentpanel">
            ...
            {!!Form::open(array('url' => ['vendors/salesPerson_updates',$data->id], 'method' => 'post', 'class' => 'tab-form attribute_form', 'id' => 'edit_driver_form', 'files' => true));!!} 
                <div class="tab-content mb30">
                    <div class="tab-pane active" id="home3">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input type="text" name="first_name" maxlength="30" placeholder="@lang('messages.First Name')" class="form-control" value="{!! $data->name !!}" />
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <div class="input-group">
                                    <input type="password" class="form-control" maxlength="32" name="user_password" autocomplete="off" value="" placeholder="@lang('messages.Password')">
                        ...
                        <div class="form-group">
							...
							<div class="col-sm-6">
								<input id="target" type="text" onKeyPress="return disableEnterKey(event)" name="address" value="{!! $data->address !!}" placeholder="Search your place and press enter"  class=" input-text select_place validate-place-map form-control"  maxlength="100"/>
                    ...
                    <div class="panel-footer">
                        ...
                        <button type="reset" title="Cancel" class="btn btn-default" onclick="window.location='{{ url('vendors/salesPerson') }}'">@lang('messages.Cancel')</button>
                    </div>
                </div>
            {!!Form::close();!!} 
        </div>
