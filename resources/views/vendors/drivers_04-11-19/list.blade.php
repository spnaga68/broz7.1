	...
	@if(hasTask('admin/drivers/create'))
		<div class="buttons_block pull-right">
			<div class="btn-group mr5">
				<a class="btn btn-primary tip" href="{{ URL::to('vendor/create_driver') }}" title="Add New"><i class="fa fa-plus"> </i> @lang('messages.Add New')</a>
			</div>
		</div>
	@endif
	...
	<table id="driversTable" class="table table-striped table-bordered responsive">
		<thead>
			<tr class="headings">
				...
				<?php if(hasTask('admin/drivers/create')) { ?>
...
<script>
    $(function() {
        $('#driversTable').DataTable({
            ...
            responsive: true,
            autoWidth:false,
            ajax: '{!! route('listvendorDriverAjax.data') !!}',
            "order": [],
            "columnDefs": [ {
                "targets"  : 'no-sort',
				"orderable": true,
