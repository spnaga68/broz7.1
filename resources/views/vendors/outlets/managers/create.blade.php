...
<div class="row">
    <div class="col-md-12 ">
        ...
        <div class="contentpanel">
            ...
            {!!Form::open(array('url' => 'vendor/create_manager', 'method' => 'post', 'class' => 'tab-form attribute_form', 'id' => 'create_driver_form', 'files' => true));!!} 
                <div class="tab-content mb30">
                    <div class="tab-pane active" id="home3">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                              <input type="text" name="country_code" maxlength="12" placeholder="@lang('messages.Countrycode')" class="form-control" value="{!! old('Countrycode') !!}" />
