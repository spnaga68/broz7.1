...
<div class="row">
    <div class="col-md-12 ">
        ...
        <div class="contentpanel">
            ...
            {!!Form::open(array('url' => ['vendor/managers/update',$data->id], 'method' => 'post', 'class' => 'tab-form attribute_form', 'id' => 'edit_manager_form', 'files' => true));!!}
                <div class="tab-content mb30">
                    <div class="tab-pane active" id="home3">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <div class="input-group">
                                    <input type="password" class="form-control" maxlength="30" name="user_password" autocomplete="off" value="" placeholder="">
                        ...
                        <div class="form-group">
                          ...
                          <div class="form-group">
                            <label class="col-sm-2 control-label">@lang('messages.Countrycode')<span class="asterisk">*</span></label>
                            <div class="col-sm-6">
                              <input type="text" name="country_code" maxlength="12" placeholder="@lang('messages.Countrycode')" class="form-control" value="{!! $data->country_code !!}" />
                              <span class="help-block">@lang('messages.Countrycode(s) in comma seperated. <br>For example: +971,+91')</span>
                            </div>
                        </div>

                         <div class="form-group">
                            <label class="col-sm-2 control-label">@lang('messages.Pin')<span class="asterisk">*</span></label>
                            <div class="col-sm-6">
                              <input type="text" name="pin" maxlength="12" placeholder="@lang('messages.Pin')" class="form-control" value="{!! $data->outlet_key !!}" />
                              <span class="help-block">@lang('messages.Pin length must be 4 digit Numbers')</span>
                            </div>
                        </div>
                                ...
                                <select name="outlet_name" id="outlet_name" class="form-control" >
                                    ...
                                    @if(count($outlet_list) > 0)
                                        @foreach($outlet_list as $ot)
                                            <option value="{{$ot->id}}" <?php if($ot->id == $data->outlet_id) { echo 'selected'; }?> >{{ ucfirst($ot->outlet_name) }}</option>
                                        @endforeach
                                    @else
                                ...
                                <div class="col-sm-10">
                                    <a class="pull-left profile-thumb">    
                                        <?php if(file_exists(base_path().'/public/assets/admin/base/images/managers/thumb/'.$data->profile_image) && $data->profile_image != '') { ?>
                                            <img src="<?php echo url('/assets/admin/base/images/managers/thumb/'.$data->profile_image); ?>" class="img-circle">
                                        <?php } else{  ?>
                    ...
                    <div class="panel-footer">
                        ...
                        <button type="reset" title="Cancel" class="btn btn-default" onclick="window.location='{{ url('vendor/outletmanagers') }}'">@lang('messages.Cancel')</button>
                    </div>
                </div>
            {!!Form::close();!!} 
        </div>
