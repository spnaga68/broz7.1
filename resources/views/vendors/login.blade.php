                    ...
                    <div class="admin_login_inner">
                        <div class="panel panel-default">
                            <div class="panel-heading">
	                          ...
	                          <?php if ($locale == 'en') {?>
                                    <img title="<?php echo Session::get("general")->site_name; ?>" alt="<?php echo Session::get("general")->site_name; ?>" src="<?php echo url('/assets/front/'.strtolower(Session::get("general")->theme).'/images/logo/159_81/admin_logo.png'); ?>" >
                               <?php } else { ?>  
								   <img title="<?php echo Session::get("general")->site_name; ?>" alt="<?php echo Session::get("general")->site_name; ?>" src="<?php echo url('/assets/front/'.strtolower(Session::get("general")->theme).'/images/logo/159_81/logo_arabic.png?'.time()); ?>" >
								 <?php } ?>     
                                </div>
                            </div>
                            <div class="panel-body">
                                ...
                                @endif
                                <form class="form-horizontal" role="form" method="POST" action="{{ url('vendors/signin') }}">
                                    {!! csrf_field() !!}
                                    ...
                                    <div class="form-group">
                                        <div class="login_update_new">
                                            <div class="col-md-12">
                                                ...
                                                <div class="col-md-12">
                                                    <a class="btn btn-link" href="{{ url('/vendors/reset') }}">@lang('messages.Forgot Your Password?')</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div> 
