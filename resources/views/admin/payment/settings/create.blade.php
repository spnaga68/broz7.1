...
<div class="media">
	...
	<div class="media-body">
		...
		<h4>@lang('messages.Add Payemnt Gateway')</h4>
	</div>
</div><!-- media -->
</div><!-- pageheader -->
...
<ul class="nav nav-tabs"></ul>
       {!!Form::open(array('url' => 'create_payment_gateway', 'method' => 'post','class'=>'tab-form attribute_form','id'=>'payment_form','files' => true));!!} 
	...
	<div class="tab-pane active" id="home3">		
		<div class="form-group">
                ...
                <div class="col-sm-10">
                    ...
                    <div class="input-group translatable_field language-<?php echo $language->id;?>" <?php if($i > 0):?>style="display: none;"<?php endif;?>>
                          <input type="text" name="gateway_name[<?php echo $language->id;?>]" id="suffix_<?php echo $language->id;?>"  placeholder="<?php echo trans('messages.Gateway Name').trans('messages.'.'('.$language->name.')');?>" class="form-control" value="{!! Input::old('gateway_name.'.$language->id) !!}"  />
		...
		<div class="form-group">
			...
			<div class="col-sm-10">
			  <input type="text" name="merchant_account_id" value="{!! old('merchant_account_id') !!}"   maxlength="255" placeholder="@lang('messages.Merchant Account Id')"  class="form-control"  />
		...
		<div class="form-group">
			...
			<div class="col-sm-10">
			  <input type="text" name="merchant_key" value="{!! old('merchant_key') !!}"   maxlength="255" placeholder="@lang('messages.Merchant Key')"  class="form-control"  />
			  <span class="help-block"></span>
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-10">
			  <input type="text" name="merchant_secret_key" value="{!! old('merchant_secret_key') !!}"  maxlength="255" placeholder="@lang('messages.Merchant Secret Key')"  class="form-control"  />
			  <span class="help-block"></span>
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-10">
			  <input type="text" name="merchant_password" value="{!! old('merchant_password') !!}"  maxlength="255" placeholder="@lang('messages.Merchant Password')"  class="form-control"  />
			  <span class="help-block"></span>
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-10">
			  <input type="text" name="payment_commision" value="{!! old('payment_commision') !!}"  maxlength="3" placeholder="@lang('messages.Payment Commision')"  class="form-control"  />
		...
		<div class="form-group">
			...
			<div class="col-sm-10">
				<input   type="radio"  value="1" checked name="payment_mode">
				<span>@lang('messages.Test')</span>
				<input   type="radio"  value="2" name="payment_mode">
