...
<div class="media">
	...
	<div class="media-body">
		...
		<h4>@lang('messages.Stock Status List')</h4>
	</div>
</div><!-- media -->
</div><!-- pageheader -->
...
<a class="btn btn-primary tip" href="{{ URL::to('admin/stockstatus/create') }}" title="Add New">@lang('messages.Add New')</a>
</div>
</div>
 ...
 <table id="currencyTable" class="table table-striped table-bordered responsive">
    <thead>
        <tr class="headings">
            ...
            <th>@lang('messages.Stock Status Name')</th>  
...
$(function() {
    $('#currencyTable').DataTable({
        ...
        ajax: '{!! route('ajaxstockstatus.data') !!}',
        "order": [],
		"columnDefs": [ {
		  "targets"  : 'no-sort',
		  "orderable": false,
