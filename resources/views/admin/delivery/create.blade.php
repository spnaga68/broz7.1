...
<div class="row">
    <div class="col-md-12 ">
        ...
        <div class="contentpanel">
            ...
            {!!Form::open(array('url' => 'create_driver', 'method' => 'post', 'class' => 'tab-form attribute_form', 'id' => 'create_driver_form', 'files' => true));!!} 
                <div class="tab-content mb30">
                    <div class="tab-pane active" id="home3">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input type="text" name="first_name" maxlength="56" placeholder="@lang('messages.First Name')" class="form-control" value="{!! old('first_name') !!}" />
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label">@lang('messages.Last Name') <span class="asterisk">*</span></label>
                            <div class="col-sm-6">
                                <input type="text" name="last_name" maxlength="56" placeholder="@lang('messages.Last Name')" class="form-control" value="{!! old('last_name') !!}" />
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label">@lang('messages.Email') <span class="asterisk">*</span></label>
                            <div class="col-sm-6">
                                <input type="text" name="email" maxlength="255" placeholder="@lang('messages.Email')" class="form-control" value="{!! old('email') !!}" />
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                              <input type="text" name="mobile" maxlength="200" placeholder="@lang('messages.Mobile')" class="form-control" value="{!! old('mobile') !!}" />
