...
<div class="media">
	...
	<div class="media-body">
		...
		<h4>@lang('messages.Order Statuses List')</h4>
	</div>
</div><!-- media -->
</div><!-- pageheader -->
...
<a class="btn btn-primary tip" href="{{ URL::to('admin/orderstatus/create') }}" title="Add New">@lang('messages.Add New')</a>
</div>
</div>
 ...
 <table id="currencyTable" class="table table-striped table-bordered responsive">
    <thead>
        <tr class="headings">
            ...
            <th>@lang('messages.Order Status Name')</th>  
...
$(function() {
    $('#currencyTable').DataTable({
        ...
        ajax: '{!! route('ajaxorderstatus.data') !!}',
        "order": [],
		"columnDefs": [ {
		  "targets"  : 'no-sort',
		  "orderable": false,
