...
<div class="pageheader">
	<div class="media">
		...
		<div class="media-body">
			...
			<h4>@lang('messages.Edit Currency') - <?php echo ucfirst($data->currency_name); ?></h4>
		</div>
	</div><!-- media -->
</div><!-- pageheader -->
...
<div class="contentpanel">
	...
	{!!Form::open(array('url' => ['admin/currency/update', $data->id], 'method' => 'post','class'=>'tab-form attribute_form','id'=>'language_form','files' => true));!!} 
			...
			<div class="tab-pane active" id="home3">
				<div class="form-group"> 
                    ...
                    <div class="input-group translatable_field language-<?php echo $language->id;?>" <?php if($i > 0):?>style="display: none;"<?php endif;?>>
                          <input type="text" name="currency_name[<?php echo $language->id;?>]" id="suffix_<?php echo $language->id;?>"  placeholder="<?php echo trans('messages.Currency Name').trans('messages.'.'('.$language->name.')');?>" class="form-control" value="{{$infomodel->getLabel('currency_name',$language->id,$data->id)}}"  maxlength="30" />
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<input type="text" name="currency_code" id="currency_code" maxlength="3" placeholder="@lang('messages.Currency Code')" class="form-control" value="{!! $data->currency_code !!}" />
					</div>
				</div>
				<div class="form-group">
					<label class="col-sm-2 control-label">@lang('messages.Numeric ISO Code') <span class="asterisk">*</span></label>
					<div class="col-sm-10">
						<input type="text" name="numeric_iso_code" id="numeric_iso_code" maxlength="3" placeholder="@lang('messages.Numeric ISO Code')" class="form-control" value="{!! $data->numeric_iso_code !!}" />
					</div>
				</div>
				<div class="form-group">
                    ...
                    <?php $i = 0; foreach($languages as $langid => $language):?>
                    <div class="input-group translatable_field language-<?php echo $language->id;?>" <?php if($i > 0):?>style="display: none;"<?php endif;?>>
                          <input type="text" name="currency_symbol[<?php echo $language->id;?>]" id="suffix_<?php echo $language->id;?>"  placeholder="<?php echo trans('messages.Currency Symbol').trans('messages.'.'('.$language->name.')');?>" class="form-control" value="{{$infomodel->getLabel('currency_symbol',$language->id,$data->id)}}"  maxlength="30" />
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<input type="text" name="exchange_rate" id="exchange_rate" maxlength="20" placeholder="@lang('messages.Exchange Rate')" class="form-control" value="{!! $data->exchange_rate !!}" />
					</div>
				</div>
				<div class="form-group">
					<label class="col-sm-2 control-label">@lang('messages.Decimal Places')</label>
					<div class="col-sm-10">
						<input type="text" name="decimal_values" id="decimal_values" maxlength="20" placeholder="@lang('messages.Decimal Places')" class="form-control" value="{!! $data->decimal_values !!}" />
					</div>
				</div>
				<div class="form-group">
					<label  class="col-sm-2 control-label">@lang('messages.Status')</label>
					<div class="col-sm-10">
						<?php $checked="";  if($data->default_status){ $checked = "checked=checked"; }?>
