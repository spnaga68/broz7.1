...
<div class="media">
	...
	<div class="media-body">
		...
		<h4>@lang('messages.Add Country')</h4>
	</div>
</div><!-- media -->
</div><!-- pageheader -->
...
<ul class="nav nav-tabs"></ul>
       {!!Form::open(array('url' => 'createcountry', 'method' => 'post','class'=>'tab-form attribute_form','id'=>'country_form','files' => true));!!} 
	...
	<div class="tab-pane active" id="home3">		
		<div class="form-group">
                ...
                <div class="col-sm-10">
                    ...
                    <div class="input-group translatable_field language-<?php echo $language->id;?>" <?php if($i > 0):?>style="display: none;"<?php endif;?>>
                          <input type="text" name="country_name[<?php echo $language->id;?>]" id="suffix_<?php echo $language->id;?>"  placeholder="<?php echo trans('messages.Country Name ').trans('messages.'.'('.$language->name.')');?>" class="form-control" value="{!! Input::old('country_name.'.$language->id) !!}" maxlength="32" />
		...
		<div class="form-group">
			...
			<div class="col-sm-10">
			  <input type="text" name="iso_code" value="{!! old('iso_code') !!}"   maxlength="8" placeholder="@lang('messages.Country Numeric Code')"  class="form-control"  />
		...
		<div class="form-group">
			...
			<div class="col-sm-10">
			  <input type="text" name="alpha_code" value="{!! old('alpha_code') !!}"   maxlength="8" placeholder="@lang('messages.Country Alpha 2 Code')"  class="form-control"  />
		...
		<div class="form-group">
			...
			<div class="col-sm-10">
			  <input type="text" name="country_isd_code" value="{!! old('country_isd_code') !!}"  maxlength="8" placeholder="@lang('messages.Country ISD Code')"  class="form-control"  />
