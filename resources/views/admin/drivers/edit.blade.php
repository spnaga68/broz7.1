                    ...
                    <div class="tab-pane active" id="home3">
                       <?php /** <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input type="text" name="first_name" maxlength="30" placeholder="@lang('messages.First Name')" class="form-control" value="{!! $data->first_name !!}" />
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label">@lang('messages.Last Name') <span class="asterisk">*</span></label>
                            <div class="col-sm-6">
                                <input type="text" name="last_name" maxlength="30" placeholder="@lang('messages.Last Name')" class="form-control" value="{!! $data->last_name !!}" />
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label class="col-sm-2 control-label">@lang('messages.Vendor') </label>
                            <div class="col-sm-6">
                                <select name="vendor" id="vendor_id" class="form-control" >
                                    ...
                                    @foreach($vendors as $list)
                                        <option value="{{$list->id}}" <?php echo ($data->vendor_driver==$list->id)?'selected="selected"':'';  ?> >{{$list->vendor_name}}</option>
                                    @endforeach
                                </select>
                            </div>
                       </div>
