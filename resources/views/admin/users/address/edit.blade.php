...
<div class="media">
	...
	<div class="media-body">
		...
		<h4>@lang('messages.Edit Address Type') - {{$infomodel->getLabel('name',getAdminCurrentLang(),$data->id)}}</h4>
	</div>
</div><!-- media -->
</div><!-- pageheader -->
...
<ul class="nav nav-tabs"></ul>
       ...
       {!!Form::open(array('url' => ['update_addresstype', $data->id], 'method' => 'post','class'=>'tab-form attribute_form','id'=>'return_form','files' => true));!!} 
		...
		<div class="form-group">
                ...
                <div class="col-sm-10">
                    ...
                    <div class="input-group translatable_field language-<?php echo $language->id;?>" <?php if($i > 0):?>style="display: none;"<?php endif;?>>
                          <input type="text" name="address_type[<?php echo $language->id;?>]" id="suffix_<?php echo $language->id;?>"  placeholder="<?php echo trans('messages.Address Type').trans('messages.'.'('.$language->name.')');?>" class="form-control" value="{{$infomodel->getLabel('name',$language->id,$data->id)}}"  maxlength="30" />
