...
<div class="media">
	...
	<div class="media-body">
		...
		<h4>@lang('messages.Edit Group') - <?php echo ucfirst($data->group_name); ?></h4>
	</div>
</div><!-- media -->
</div><!-- pageheader -->
...
<ul class="nav nav-tabs"></ul>
       ...
       {!!Form::open(array('url' => ['update_group', $data->group_id], 'method' => 'post','class'=>'tab-form attribute_form','id'=>'return_form','files' => true));!!} 
	...
	<div class="tab-pane active" id="home3">
		...
		<div class="form-group">
					...
					<div class="col-sm-10">
						<input type="text" autofocus name="group_name" id="" maxlength="32" placeholder="@lang('messages.Group Name')" class="form-control" value="{!! $data->group_name !!}" />
					</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-10">
				<input type="text" autofocus name="group_info" id="" maxlength="150" placeholder="@lang('messages.Group Info')" class="form-control" value="{!! $data->group_info !!}" />
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-10">
			<?php $checked="";  if($data->group_status){ $checked = "checked=checked"; }?>
