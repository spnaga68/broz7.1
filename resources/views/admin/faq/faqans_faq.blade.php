                ...
                <div class="tab-content mb30">
                    <div class="tab-pane active" id="home3">
                       ...
                       <!--  <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" maxlength="100" name="box" id="subject" placeholder="@lang('messages.Id')" class="form-control" value="{!! old('Id') !!}" required />
                            </div>
                        </div> -->
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" maxlength="100" name="name" id="subject" placeholder="@lang('messages.Question')" class="form-control" value="{!! old('question') !!}" required />
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" maxlength="100" name="value" id="answer" placeholder="@lang('messages.Answer')" class="form-control" value="{!! old('answer') !!}"required />
                            </div>
                        </div>
                    ...
                    <div class="panel-footer">
                        <button type="button" class="btn btn-primary mr5" name="submit" id="submit" onclick="window.location='{{ url('admin/faq/index') }}'"
