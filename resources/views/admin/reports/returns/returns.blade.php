...
<div class="pageheader">
	<div class="media">
		...
		<div class="media-body">
			...
			<h4>@lang('messages.Return orders report')</h4>
		</div>
	</div><!-- media -->
</div><!-- pageheader -->
<div class="contentpanel">
	...
	{!!Form::open(array('method' => 'POST','class'=>'tab-form attribute_form','id'=>'reports_return_order_form','files' => true));!!}
		...
		<table id="ReportsOrdersTable" class="table table-striped table-bordered responsive">
			<thead>
				<tr class="headings">
					...
					<th>@lang('messages.No. Returns')</th>
				</tr>
			</thead>
			<tbody>
				<tr>
					<td class="empty-text" colspan="3" style="background-color: #fff!important;">
...
<script> 
    ...
    $(function()
	{
		...
		autoWidth:true,
        ajax: {
           // url: '{{ URL::to('reports/report_return_order_list') }}',
            url: '{!! route('report_return_order_list.data') !!}',
        ...
        columns: [
				...
				{ data: 'return_orders_count', name: 'return_orders_count' },
			],
		
		});
		$('#reports_return_order_form').on('submit', function(e) {
			oTable.draw();
			e.preventDefault();
		});
	});
