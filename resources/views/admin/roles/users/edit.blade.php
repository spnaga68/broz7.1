...
<div class="media">
	...
	<div class="media-body">
		...
		<h4>@lang('messages.Edit user') - {{ $data->email }}</h4>
	</div>
</div><!-- media -->
</div><!-- pageheader -->
...
<ul class="nav nav-tabs"></ul>
       {!!Form::open(array('url' =>['usersupdate', $data->ruid], 'method' => 'post','class'=>'tab-form attribute_form','id'=>'currency_form','files' => true));!!} 
           ...
           <div class="form-group">
                ...
                <div class="col-sm-10">
					...
					<?php foreach($roles as $list):?>
                          <option  value="<?php echo $list->id;?>" <?php if($data->role_id==$list->id){  echo "selected=selected"; }  ?> ><?php echo ucfirst($list->role_name);?></option>
                      <?php endforeach;?>
					</select>	                 
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
					...
					<?php foreach($users as $list):?>
                          <option  value="<?php echo $list->id;?>" <?php if($data->user_id==$list->id){  echo "selected=selected"; }  ?> ><?php echo $list->email;?></option>
                      <?php endforeach;?>
					</select>	                 
                </div>
            </div>
