...
<div class="row">
    <div class="col-md-12 ">
            ...
            <div class="media">
                ...
                <div class="media-body">
                    <ul class="breadcrumb">
                        ...
                        <li>@lang('messages.Email notifications')</li>
                    </ul>
                    <h4>@lang('messages.Email notifications')</h4>
                </div>
            </div><!-- media -->
        </div><!-- pageheader -->
        ...
        <div class="contentpanel">
            ...
            {!!Form::open(array('url' => 'send_email', 'method' => 'post','class'=>'tab-form attribute_form','id'=>'newsletter_form','files' => true));!!} 
