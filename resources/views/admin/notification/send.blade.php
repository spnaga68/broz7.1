...
<div class="row">
    <div class="col-md-12 ">
        ...
        <div class="contentpanel">
            ...
            {!!Form::open(array('url' => 'send_notification', 'method' => 'post','class'=>'tab-form attribute_form','id'=>'newsletter_form','files' => true));!!} 
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <select name="entity_type" class="form-control" id="entity_type">
                                    <option value = '2'>Estate Managers</option>
                                    <option value = '4'>Residents</option>
                                    <option value = '3'>Security Guards</option>
                                </select>
                            </div>
                        </div>
                        <?php } else { ?>
				 ...
				 success: function(res) { 
					...
					if(res.data!=''){ 
						$.each(res.data, function(key, value) {
							html +='<option value='+value["email"]+'>'+ value["email"]+" - "+value["name"]+'</option>'; 
					   });
				   }else{
