            ...
            @endif
                <div class="tab-content mb30">
                    <div class="tab-pane active" id="home3">
                     	{!!Form::open(array('url' => ['admin/settings/updateterms'], 'method' => 'post','class'=>'tab-form attribute_form','id'=>'terms_of_service','files' => true));!!}
                        <?php //echo"<pre>"; print_r($details);exit(); ?>
	 						<div class="form-group">
	                            ...
	                            <div class="col-sm-10">
	                                <input type="text" maxlength="100" name="title" id="title" placeholder="@lang('messages.title')" class="form-control" value="{{$details->title}}"required />
	                            </div>
                                <input type="hidden" name="id" value="{{$details->id}}">
	                        </div>

                            <div class="form-group">
                                <label class="col-sm-2 control-label">@lang('messages.title_const') <span class="asterisk">*</span></label>
                                <div class="col-sm-10">
                                    <input type="text" maxlength="100" name="title_const" id="title_const" placeholder="@lang('messages.title_const')" class="form-control" value="{{$details->title_const}}"required readonly/>
                                </div>
                                <input type="hidden" name="id" value="{{$details->id}}">
                            </div>
	                        <div class="form-group">
	                            ...
	                            <div class="col-sm-10">
	                                <textarea type="text" class="content" rows="7"  name="content" >{{$details->content}}</textarea> 
	                            </div>
	                        </div>
