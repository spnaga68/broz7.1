    ...
    <div class="container">
        <div class="footer_common row">
            ...
            <div class="col-md-5 padding_left0">
               ...
               <p>@lang('messages.Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium,totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta.Sed ut perspiciatis unde omnis ist.')</p>
            </div>
            ...
            <div class="col-md-3 col-sm-6 col-xs-6">
                <div class="cms_listing">
                    <address>
                        <p><i class="glyph-icon flaticon-paper"></i><?php echo Session::get("configemail")->contact_mail; ?></p>
        ...
        <div class="copy_rights">
            ...
            <p>@lang('messages.© Oddappz.com. All rights reserved.')</p>
            </div>
        </div>
    </div>
</footer>
