<div class="leftpanel">
	...
	<ul class="nav nav-pills nav-stacked">
				...
				<ul class="children">
					...
					<li class="parent {{ Request::is('admin/localisation*') ? 'active' : '' || Request::is('admin/country*') ? 'active' : '' || Request::is('admin/localisation/language*') ? 'active' : '' || Request::is('admin/language*') ? 'active' : '' || Request::is('admin/city*') ? 'active' : ''|| Request::is('admin/currency*') ? 'active' : '' || Request::is('admin/stockstatus*') ? 'active' : '' || Request::is('admin/orderstatus*') ? 'active' : '' || Request::is('admin/returnstatus*') ? 'active' : '' || Request::is('admin/returnaction*') ? 'active' : '' || Request::is('admin/returnreason*') ? 'active' : '' || Request::is('admin/payment*') ? 'active' : '' || Request::is('admin/modules*') ? 'active' : '' || Request::is('admin/zones*') ? 'active' : '' }} ">
						...
						<ul class="sub children">
							...
							<li class="{{ Request::is('admin/localisation/stockstatuses*') ? 'active' : '' || Request::is('admin/stockstatus*') ? 'active' : ''  }}" ><a href="{{ URL::to('admin/localisation/stockstatuses') }}">@lang('messages.Stock Statuses')</a></li>
							<li class="{{ Request::is('admin/localisation/orderstatuses*') ? 'active' : '' || Request::is('admin/orderstatus*') ? 'active' : ''  }}"><a href="{{ URL::to('admin/localisation/orderstatuses') }}">@lang('messages.Order Statuses')</a></li>
							<li class="{{ Request::is('admin/localisation/returnstatuses*') ? 'active' : '' || Request::is('admin/returnstatus*') ? 'active' : '' }}"><a href="{{ URL::to('admin/localisation/returnstatuses') }}">@lang('messages.Return Statuses')</a></li>
							<li class="{{ Request::is('admin/localisation/returnactions*') ? 'active' : '' || Request::is('admin/returnaction*') ? 'active' : '' }}"><a href="{{ URL::to('admin/localisation/returnactions') }}">@lang('messages.Return Actions')</a></li>
							<li class="{{ Request::is('admin/localisation/returnreasons*') ? 'active' : '' || Request::is('admin/returnreason*') ? 'active' : '' }}"><a href="{{ URL::to('admin/localisation/returnreasons') }}">@lang('messages.Return Reasons')</a></li>
					...
					<li class="{{ Request::is('admin/modules/settings*') ? 'active' : '' || Request::is('admin/modules/edit*') ? 'active' : '' }}" ><a href="{{ URL::to('admin/modules/settings') }}">@lang('messages.Module Settings')</a></li>
		...
		<?php } ?>
        <?php if(hasTask('vendors/vendors') || hasTask('vendors/outlets') || hasTask('vendors/outlet_managers')){ ?>
		...
		<?php if(hasTask('admin/orders/index') || hasTask('orders/return_orders') || hasTask('orders/fund_requests')){ ?>
			<li class="parent {{ (Request::is('orders/*') || Request::is('admin/orders*')) ? 'active' : ''}}"><a  href="javascript:;"><i class="fa fa-database"></i> <span>@lang('messages.Sales')</span></a>
				...
				<?php } ?>
			<?php /*	<?php if(hasTask('orders/fund_requests')){ ?>
	...
	<?php /*	<?php if(hasTask('admin/drivers')){ ?>
			<li  class="{{ Request::is('admin/drivers*') ? 'active' : '' }}" ><a href="{{ URL::to('admin/drivers') }}"><i class="fa fa-automobile"></i> <span>@lang('messages.Drivers')</span></a></li>
		<?php } ?> */ ?>
        ...
        <?php if(hasTask('admin/notifications')){ ?>
			<li class="{{ Request::is('admin/notifications*') ? 'active' : '' }}" ><a href="{{ URL::to('admin/notifications') }}"><i class="fa fa-bell"></i> <span>@lang('messages.Notifications')</span></a></li>
		<?php } ?>
	</ul>
	<footer>
