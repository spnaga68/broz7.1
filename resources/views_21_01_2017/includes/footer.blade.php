    ...
    <div class="container">
        <div class="footer_common row">
            ...
            <div class="col-md-5 padding_left0">
                ...
                <p><?php echo Session::get("general")->footer_text; ?></p>
            </div>
        ...
        <div class="copy_rights">
            ...
            <p><?php echo Session::get("general")->copyrights; ?></p>
            </div>
        </div>
    </div>
</footer>
...
@include('front.login')
@include('front.member_signup')
@include('front.signup')
@include('front.forgot')
@include('front.store_register')
