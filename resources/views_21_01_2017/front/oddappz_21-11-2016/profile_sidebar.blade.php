			...
			<div id="preview">
				<a href="javascript:;" title="@lang('messages.Change image')">
					...
					*/ ?>
					...
					<?php if(file_exists(base_path().'/public/assets/admin/base/images/admin/profile/'.$user_details->image) && $user_details->image != '') { ?>
                       <img src="<?php echo url('/assets/admin/base/images/admin/profile/'.$user_details->image); ?>" class="img-circle img-offline img-profile">
                   <?php } else{ ?>
