...
<h4>@lang('messages.Delivered in') {{ $data->outlets_delivery_time }}<label>@lang('messages.Mins')</label></h4>
	...
	<li <?php if($fstatus){ ?> class="info_active" <?php } ?> ><a style="cursor:pointer;" onclick="back_product()" ><i class="icons"><img src="<?php echo URL::asset('assets/front/'.Session::get("general")->theme.'/images/home_icon.png');?>" alt=""></i></a></li>
...
<h4>from {{ $data->outlets_delivery_charges_fixed }} {{ getCurrency() }}</h4>
</div>
</div>
<div class="delevery_free">
