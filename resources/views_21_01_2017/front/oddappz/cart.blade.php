                    ...
                    <div class="table-responsive cart_items"> 
                        ...
                        <div class="price_setions">
                            ...
                            <div class="price_setions_list">
								...
								<?php if($currency_side == 1) { ?>
                                     <div class="col-md-2 col-sm-6 col-xs-6"><p>{{$currency_symbol}}<span id="tax">{{$tax}}</span></span></p></div>
								<?php } else { ?>
                                     <div class="col-md-2 col-sm-6 col-xs-6"><p><span id="tax">{{$tax}}</span>{{$currency_symbol}}</span></p></div>
								<?php } ?>	 
