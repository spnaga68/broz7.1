                        ...
                        {!!Form::open(array('url' => 'login', 'method' => 'post', 'class' => 'tab-form attribute_form', 'id' => 'login','onsubmit'=>'return login()'));!!} 
                            <div class="col-md-6 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    <input type="email" maxlength="256" name="email" class="form-control" required id="exampleInputEmail" placeholder="@lang('messages.Email')">
                                </div>
                            </div>
                            <div class="col-md-6 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    <input type="password" maxlength="32" name="password" class="form-control" required id="exampleInputPassword13" placeholder="@lang('messages.Password')">
                                </div>
                            </div>
                            <div class="col-md-6 col-sm-12 col-xs-12">
                                <div class="form-group">
