        ...
        <div class="contact_us_inner row">
            ...
            <div class="col-md-4 col-sm-6 col-xs-12">
                <div class="contact_det">
                    ...
                    <address>
                        <h4><i class="glyph-icon flaticon-location-pin"></i><?php echo Session::get("general")->site_name; ?><br><p><?php echo Session::get("general")->contact_address; ?></p></h4>
                    ...
                    <div class="social_share contact_us_social">
                        <ul>
                            <li>
                                <a title="@lang('messages.Facebook')" class="face"target="_blank"  href="<?php echo Session::get("social")->facebook_page; ?>"> <i class="glyph-icon flaticon-facebook-logo"></i></a>
                            </li>
                            <li>
                                <a title="@lang('messages.Instagram')" class="ins" target="_blank" href="<?php echo Session::get("social")->google_plus_page; ?>"><i class="glyph-icon flaticon-instagram-social-network-logo-of-photo-camera"></i></a>
                            </li>
                            <li>
                                <a title="@lang('messages.Twitter')" class="twi" target="_blank" href="<?php echo Session::get("social")->twitter_page; ?>"><i class="glyph-icon flaticon-twitter-logo-silhouette"></i></a>
                            </li>
                            <li>
                                <a title="@lang('messages.linkein')" class="link" target="_blank" href="<?php echo Session::get("social")->linkedin_page; ?>"><i class="glyph-icon flaticon-linkedin-logo"></i></a>
                            </li>
                        </ul>
                    </div>
                </div>
                     ...
                     {!!Form::open(array('url' => 'postcontactus', 'method' => 'post','class'=>'col s12','id'=>'contactus_form','files' => true));!!}
                        ...
                        <div class="col-md-5 col-sm-12 col-xs-12">
                            <div class="form-group">
                                ...
                                <span class="error">@if ($errors->has('mobile_number')){{ $errors->first('mobile_number', ':message') }}@endif</span>
                            </div>
                        </div>
