                         ...
                         {!!Form::open(array('url' => 'postcontactus', 'method' => 'post','class'=>'col s12','id'=>'contactus_form','files' => true));!!}
                            <div class="col-md-7 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    <input type="text" class="form-control" value="{!! old('name') !!}" name="name" required placeholder="@lang('messages.Name')">
                                    <span class="error"> 
                                                @if ($errors->has('name'))
                            ...
                            <div class="col-md-5 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    <input type="text" class="form-control" type="tel" value="{!! old('mobile_number') !!}" name="mobile_number"  required placeholder="@lang('messages.Phone')">
                                    <span class="error">  
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="form-group">
                                     <input id="email" type="email" value="{!! old('email') !!}" name="email" class="form-control" required placeholder="@lang('messages.Email')">
                                                                                        <span class="error"> 
                                                @if ($errors->has('email'))
                            ...
                            <div class="col-md-6 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    <div class="sign_upcooper">
                                        <select class="js-example-disabled-results" required style="width:100%;" name="city" >
                                            <option value="one">@lang('messages.Select City')</option>
                            ...
                            <div class="col-md-6 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    <div class="sign_upcooper">
                                        <select class="js-example-disabled-results" required style="width:100%;" name="enquery_type">
