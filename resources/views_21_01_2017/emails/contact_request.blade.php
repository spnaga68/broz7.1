...
<div class="block">
   ...
   <table width="100%" bgcolor="#f6f4f5" cellpadding="0" cellspacing="0" border="0" id="backgroundTable" st-sortable="header">
      <tbody>
         <tr>
            <td>
               <table width="580" bgcolor="#1A508E" cellpadding="0" cellspacing="0" border="0" align="center" class="devicewidth" hlitebg="edit" shadow="edit">
                  <tbody>
                     <tr>
                        <td>
                           <!-- logo -->
                           <table width="100%" align="middle" cellpadding="0" cellspacing="0" border="0" align="left" class="devicewidth">
                              <tbody>
                                 <tr>
                                    <td valign="middle" width="270" style="padding: 10px 0 10px 20px;" class="logo">
                                       <div class="imgpop">
                                          <a style="text-align:center" href="#"><img src="<?php echo url('/assets/front/'.Session::get("general")->theme.'/images/logo/159_81/'.$general->logo.'?'.time()); ?>" alt="Solutek" border="0" style="display:block; border:none; outline:none; text-decoration:none;" st-image="edit" class="logo"></a>
                                       </div>
                                    </td>
                                 </tr>
                              </tbody>
                              ...
                              <tbody>
                                 ...
                                 <tr>
                                    <td style="font-family: Helvetica, arial, sans-serif; font-size: 18px; color: #333333; text-align:left;line-height: 20px;" st-title="rightimage-title">
                                       <b style=" display:inline-block;">Name</b> <strong>:</strong> <p style=" display:inline-block; margin:0px; font: normal 16px arial; color:#222;">{!! $name !!}</p>
                                    </td>
                                 </tr>
                                 ...
                                 <tr>
								  ...
								  <tr>
                                    <td style="font-family: Helvetica, arial, sans-serif; font-size: 18px; color: #333333; text-align:left;line-height: 20px;" st-title="rightimage-title">
                                       <b style=" display:inline-block;">Email</b> <strong>:</strong> <p style="  margin:0px; display:inline-block; font: normal 16px arial; color:#222;">{!! $email !!}</p>
                                    </td>
                                 </tr>						
                                 <!-- end of title -->
                                 <tr>
								  ...
								  <tr>
                                    <td style="font-family: Helvetica, arial, sans-serif; font-size: 18px; color: #333333; text-align:left;line-height: 20px;" st-title="rightimage-title">
                                       <b style=" display:inline-block;">Mobile Number</b> <strong>:</strong> <p style="  margin:0px; display:inline-block; font: normal 16px arial; color:#222;">{!! $mobile_number !!}</p>
                                    </td>
                                 </tr>						
                                 <!-- end of title -->
                              </tbody>
