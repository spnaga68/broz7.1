...
<ul class="nav nav-tabs"></ul>
       {!!Form::open(array('url' => 'createzone', 'method' => 'post','class'=>'tab-form attribute_form','id'=>'zone_form','files' => true));!!} 
			...
			<div class="form-group">
                ...
                <div class="col-sm-6">
                    ...
                    <div class="input-group translatable_field language-<?php echo $language->id;?>" <?php if($i > 0):?>style="display: none;"<?php endif;?>>
                          <input type="text" name="zone_name[<?php echo $language->id;?>]" id="suffix_<?php echo $language->id;?>"  placeholder="<?php echo trans('messages.Zone Name').trans('messages.'.'('.$language->name.')');?>" class="form-control" maxlength="20" value="{!! Input::old('zone_name.'.$language->id) !!}" maxlength="32" />
