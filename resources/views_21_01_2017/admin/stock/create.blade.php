...
<div class="media">
	...
	<div class="media-body">
		...
		<h4>@lang('messages.Add Stock Status')</h4>
	</div>
</div><!-- media -->
</div><!-- pageheader -->
...
<ul class="nav nav-tabs"></ul>
       {!!Form::open(array('url' => 'stock_status_create', 'method' => 'post','class'=>'tab-form attribute_form','id'=>'currency_form','files' => true));!!} 
	<div class="tab-content mb30">
	<div class="tab-pane active" id="home3">
				<div class="form-group">
					<label class="col-sm-2 control-label">@lang('messages.Stock Status Name') <span class="asterisk">*</span></label>
					<div class="col-sm-10">
						<input type="text" autofocus name="status_name" id="" maxlength="15" placeholder="@lang('messages.Stock Status Name')" class="form-control" value="{!! old('status_name') !!}" />
					</div>
				</div>
