...
<ul class="nav nav-tabs"></ul>
       {!!Form::open(array('url' => 'createcity', 'method' => 'post','class'=>'tab-form attribute_form','id'=>'city_form','files' => true));!!}
	...
	<div class="tab-pane active" id="home3">		
		<div class="form-group">
                ...
                <div class="col-sm-10">
                    ...
                    <div class="input-group translatable_field language-<?php echo $language->id;?>" <?php if($i > 0):?>style="display: none;"<?php endif;?>>
                          <input type="text" name="city_name[<?php echo $language->id;?>]" id="suffix_<?php echo $language->id;?>"  placeholder="<?php echo trans('messages.City Name').trans('messages.'.'('.$language->name.')');?>" class="form-control" value="{!! Input::old('city_name.'.$language->id) !!}" maxlength="32" />
		...
		<div class="form-group">
			...
			<div class="col-sm-10">
			  <input type="text" name="zone_code" value="{!! old('zone_code') !!}"   maxlength="3" placeholder="@lang('messages.Zone Code')"  class="form-control"  />
