			...
			<div class="tab-pane active" id="login_info">
					...
					<div class="col-sm-7">
						<select name="outlet" id="outlet_id" class="form-control" >
							...
							<?php
								...
								$outlet = getOutletList($data->vendor_id);
							?>
				...
				<div class="form-group">
					...
					<div class="col-sm-7"> <?php // echo $data->category_id; ?>
						<select name="category" id="category_id" class="form-control" >
							...
							<?php $cdata = getVendorsubCategoryLists($data->vendor_id); ?>
							@if (count($cdata) > 0)
				...
				<div class="form-group">
					...
					<div class="col-sm-7">
						...
						<?php  $sub_category = getSubCategoryLists(1,$data->category_id); ?>
				...
				<div class="form-group">
					...
					<div class="col-sm-7">
						...
						<span class="help-text">@lang('messages.Please upload 265X125 images for better quality')</span>
						<div class="mb20"></div>
