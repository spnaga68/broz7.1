...
<ul class="nav nav-tabs"></ul>
       {!!Form::open(array('url' => ['update_role', $data->id], 'method' => 'post','class'=>'tab-form attribute_form','id'=>'role-permission','files' => true));!!} 
	...
	<div class="tab-pane active" id="home3">
		...
		<div class="form-group">
			...
			<div class="col-sm-6">
				<div class=""> 
				<input type="text" name="app_key" value="{!! $data->app_key !!}" class="form-control" maxlength="36">
				<input type="hidden" name="account_id" value="{!! $data->account_id !!}" class="form-control" maxlength="36">
				</div>
		...
		<div class="col-sm-6">
				<div class="controls">
					<input type="text" name="tag_bg_color" value="{!! $data->tag_bg_color !!}"  class="form-control colorpicker-input" placeholder="#000000" id="colorpicker" />
		...
		<div class="form-group">
			...
			<div class="col-sm-6">
			<div class="controls">
			<input type="text" name="tag_text_color" value="{!! $data->tag_text_color  !!}" class="form-control colorpicker-input" placeholder="#000000"  id="colortextpicker" />
 ...
 <script>
						...
						$(window).load(function(){
							...
							$("#role_tag_prev").text($(this).val());
								...
								<?php if ($data->tag_bg_color): ?>
										jQuery('#colorSelector span').css('backgroundColor', '<?php echo $data->tag_bg_color; ?>');
										$("#role_tag_prev").css('backgroundColor', '<?php echo $data->tag_bg_color; ?>');
								<?php endif; ?>
								<?php if ($data->tag_text_color): ?>
									jQuery('#colortextSelector span').css('backgroundColor', '<?php echo $data->tag_text_color; ?>');
									$("#role_tag_prev").css('color', '<?php echo $data->tag_text_color; ?>');
								<?php endif; ?>
