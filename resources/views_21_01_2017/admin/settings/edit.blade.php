	...
	<div class="tab-content tab-content-simple mb30 no-padding" >
        <div class="tab-pane active" id="login_info">
				...
				<div class="form-group">
					...
					<div class="col-sm-8">
					  <input type="text" name="email" value="{!! $data->email !!}"  maxlength="100" placeholder="@lang('messages.Email')"  id="disabledinput" class="form-control"  />
					</div>
				</div>
		...
		<div class="form-group">
				...
				<div class="form-group">
					...
					<div class="col-sm-6">
						<input type="file" name="logo" placeholder="@lang('messages.Logo')"  class="" />
						<div class="mb20"></div>
				...
				<div class="form-group">
					...
					<div class="col-sm-6">
						<input type="file" name="featured_image" placeholder="@lang('messages.Featured Image')"  class="" />
						<div class="mb20"></div>
