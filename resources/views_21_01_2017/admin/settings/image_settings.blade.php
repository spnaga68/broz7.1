				...
				<div class="grid simple">
					...
					<div class="panel-body">
							<div class="form-group col-sm-5">
								...
								<span class="help">@lang('messages.Width')</span>
									<div class="controls">
									<input  class="form-control" type="text" style="width:100%;" value="{{ $vendor->list_width }}"  name="product_list_width">
									</div>
							</div>
							<div id="COPYRIGHTS" class="form-group col-sm-5">
								<label class="form-label">&nbsp;</label>
								<span class="help">@lang('messages.Height') <span class="asterisk">*</span></span>
									<div class="controls">
									<input  class="form-control" type="text" style="width:100%;" value="{{ $vendor->list_height }}"  name="product_list_height">
									</div>
							</div>
							<div class="form-group col-sm-5">
								<label class="form-label">@lang('messages.Detail') <span class="asterisk">*</span></label>
								<span class="help">@lang('messages.Width')</span>
									<div class="controls">
									<input  class="form-control" type="text" style="width:100%;"  value="{{ $vendor->detail_width }}" name="product_detail_width">
									</div>
							</div>
							<div id="COPYRIGHTS" class="form-group col-sm-5">
								<label class="form-label">&nbsp;</label>
								<span class="help">@lang('messages.Height') <span class="asterisk">*</span></span>
									<div class="controls">
									<input  class="form-control" type="text" style="width:100%;"   value="{{ $vendor->detail_height }}" name="product_detail_height">
									</div>
							</div>
							<div class="form-group col-sm-5">
								<label class="form-label">@lang('messages.Thumb') <span class="asterisk">*</span></label>
								<span class="help">@lang('messages.Width')</span>
									<div class="controls">
									<input  class="form-control" type="text" style="width:100%;" value="{{ $vendor->thumb_width }}"  name="product_thumb_width">
									</div>
							</div>
							<div id="COPYRIGHTS" class="form-group col-sm-5">
								<label class="form-label">&nbsp;</label>
								<span class="help">@lang('messages.Height') <span class="asterisk">*</span></span>
									<div class="controls">
									<input  class="form-control" type="text" style="width:100%;" value="{{ $vendor->thumb_height }}"  name="product_thumb_height">
									</div>
							</div>
					</div>
				</div>
