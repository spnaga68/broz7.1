...
<div class="grid simple">
	...
	<div id="instagram_page" class="form-group">
		<label class="form-label">@lang('messages.Instagram page') <span class="asterisk">*</span></label>
		<span class="help">@lang('messages.This page for Instagram  updates')</span>
		<div class="controls">
			<input class="form-control"  type="text" value="{{ $settings->instagram_page }}" required name="instagram_page">
		</div>
	</div>
