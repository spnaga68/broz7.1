...
<div class="contentpanel">
	@if(hasTask('admin/groups/create'))
		<div class="buttons_block pull-right">
			<div class="btn-group mr5">
				<a class="btn btn-primary tip" href="{{ URL::to('admin/groups/create') }}" title="Add New">@lang('messages.Add New')</a>
			</div>
		</div>
	@endif
	...
	@endif
	<table id="groupTable" class="table table-striped table-bordered responsive">
		<thead>
			<tr class="headings">
				<th>@lang('messages.S.No')</th>
				<th>@lang('messages.Group Name')</th>
				<th>@lang('messages.Status')</th>
				<?php if(hasTask('admin/groups/edit')){ ?>
