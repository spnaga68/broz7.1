...
<div class="media">
	...
	<div class="media-body">
		...
		<h4>@lang('messages.Edit Address Type') - <?php echo ucfirst($data->name); ?></h4>
	</div>
</div><!-- media -->
</div><!-- pageheader -->
...
<ul class="nav nav-tabs"></ul>
	...
	<div class="tab-pane active" id="home3">
		...
		<div class="form-group">
					...
					<div class="col-sm-10">
						<input type="text" autofocus name="address_type" id="" maxlength="32" placeholder="@lang('messages.Address Type')" class="form-control" value="{!! $data->name !!}" />
					</div>
		</div>
