...
<div class="pageheader">
	<div class="media">
		...
		<div class="media-body">
			<ul class="breadcrumb">
				<li><a href="{{url('admin/dashboard')}}"><i class="glyphicon glyphicon-home"></i>@lang('messages.Admin')</a></li>
        ...
        <div class="col-md-10 col-md-offset-1">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('/admin/password_data') }}">
                        {!! csrf_field() !!}
