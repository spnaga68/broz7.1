...
@section('content')
	<script src="{{ URL::asset('assets/front/base/plugins/rateit/src/jquery.rateit.js') }}"></script>
	<link href="{{ URL::asset('assets/front/base/plugins/rateit/src/rateit.css') }}" rel="stylesheet">
<div class="row">	
	<div class="col-md-12 ">
<!-- Nav tabs -->
