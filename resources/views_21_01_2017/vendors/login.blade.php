						...
						<div class="panel panel-default">
			                <div class="panel-heading">
								<div class="logo text-center logo_setions_absolut">
									<img title="<?php echo Session::get("general")->site_name; ?>" alt="<?php echo Session::get("general")->site_name; ?>" src="<?php echo url('/assets/front/'.strtolower(Session::get("general")->site_name).'/images/logo/159_81/admin_logo.png'); ?>" >
								</div>
							</div>
