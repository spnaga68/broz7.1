	...
	<div class="col-md-12">
		<div class="buttons_block pull-right">
			<div class="btn-group mr5">
				<a class="btn btn-primary tip" href="{{ URL::to('vendors/return_orders') }}" title="Edit" >@lang('messages.Back')</a>
			</div>
		</div>
			...
			<div class="grid simple">
				...
				<div class="tab-content tab-content-simple mb30 no-padding" >
					<div class="tab-pane active" id="login_info">
						...
						{!!Form::open(array('url' => ['vendors/update_return_orders',$data[0]->id], 'method' => 'post','id'=>'product_form','files' => true));!!}
						<div class="form-group">
					...
					<div class="tab-pane" id="contact_info"> 
						...
						<div class="form-group">
							<label class="col-sm-5 control-label">@lang('messages.Outlet Address')</label>
