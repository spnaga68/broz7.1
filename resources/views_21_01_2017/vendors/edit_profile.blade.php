...
<div class="grid simple">
	...
	{!!Form::open(array('url' => ['vendors/updateprofile', $data->id], 'method' => 'post','class'=>'tab-form attribute_form','id'=>'profile_edit_form','files' => true));!!}
	<div class="tab-content tab-content-simple mb30 no-padding" >
        <div class="tab-pane active" id="login_info">
				...
				<div class="form-group">
					...
					<div class="col-sm-8">
					  <input type="text" name="email" value="{!! $data->email !!}"  maxlength="50" placeholder="@lang('messages.Email')"  id="disabledinput" class="form-control"  />
					</div>
				</div>
			...
			<div class="tab-pane" id="vendor_info">
				...
				<div class="form-group">
					...
					<?php $i = 0; foreach($languages as $langid => $language):?>
						<div class="input-group translatable_field language-<?php echo $language->id;?>" <?php if($i > 0):?>style="display: none;"<?php endif;?>>
							  <input type="text" name="vendor_name[<?php echo $language->id;?>]" maxlength="30" id="suffix_<?php echo $language->id;?>"  placeholder="<?php echo trans('messages.Vendor Name ').trans('messages.'.'('.$language->name.')');?>" class="form-control" value="{{$infomodel->getLabel('vendor_name',$language->id,$data->id)}}"  />
			   ...
			   <div class="form-group">
                       ...
                       <div class="col-sm-9">
                            <input id="target" type="text" onKeyPress="return disableEnterKey(event)" maxlength="100" name="contact_address" value="{!! $data->contact_address !!}" placeholder="Search your place and press enter"  class=" input-text select_place validate-place-map form-control" />
			   ...
			   <div class="form-group">
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<input type="file" name="logo" placeholder="@lang('messages.Logo')"  class="form-control" />
						<div class="mb20"></div>
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<input type="file" name="featured_image" placeholder="@lang('messages.Featured Image')"  class="form-control" />
						<div class="mb20"></div>
						<img src="<?php echo url('/assets/admin/base/images/vendors/thumb/'.$data->featured_image.''); ?>" class="thumbnail img-responsive" alt="logo">
					</div>
				</div>
			</div>
			<div class="tab-pane" id="delivery_info">
				...
				<div class="form-group">
					<label  class="col-sm-4 control-label">@lang('messages.Service Tax') <span class="asterisk">*</span></label>
					<div class="col-sm-8">
			...
			<div class="tab-pane" id="contact_info">
				...
				**/ ?>				
				<?php /*<div class="form-group">
					...
					<div class="col-sm-8">
						<?php $checked = "";
						if($data->featured_vendor){ $checked = "checked=checked"; }
						?>
